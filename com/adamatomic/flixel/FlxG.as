package com.adamatomic.flixel
{
	...
	public class FlxG
	{
		...
		//@desc These are the constants for use with the Pressed and Releases functions
		static public const Q:uint = 7;
		//@desc These are the constants for use with the Pressed and Releases functions
		static public const W:uint = 8;
		//@desc These are the constants for use with the Pressed and Releases functions
		static public const E:uint = 9;
		//@desc These are the constants for use with the Pressed and Releases functions
		static public const R:uint = 10;
		//@desc These are the constants for use with the Pressed and Releases functions
		...
		//@desc A shortcut way of checking if a particular key is pressed
		static public var kQ:Boolean;
		//@desc A shortcut way of checking if a particular key is pressed
		static public var kW:Boolean;
		//@desc A shortcut way of checking if a particular key is pressed
		static public var kE:Boolean;
		//@desc A shortcut way of checking if a particular key is pressed
		static public var kR:Boolean;
		//@desc A shortcut way of checking if a particular key is pressed
		...
		{
			kUp = kDown = kLeft = kRight = kA = kB = kQ = kW = kE = kR = kMouse = false;
